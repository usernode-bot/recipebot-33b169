...
<body style="font-family:Inter,system-ui,sans-serif;background:#FAF6EE;color:#1F2B47;display:flex;align-items:center;justify-content:center;min-height:100vh;margin:0">
  <div style="max-width:24rem;padding:2rem;text-align:center">
    <h1 style="font-family:Fraunces,Georgia,serif;font-size:1.35rem;margin:0 0 0.5rem">Open this app inside Usernode</h1>
    ...
    <a href="${PLATFORM_ORIGIN}/#app/recipebot-33b169/full" style="display:inline-block;padding:0.5rem 1rem;background:#b85a24;color:#fff;border-radius:0.6rem;text-decoration:none;font-size:0.9rem">Open in Usernode</a>
  </div>
</body>`);
  }
  if (req.accepts('html')) {
